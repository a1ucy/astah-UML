   ...
   public static void main(String[] args)
   {
      ...
      do{
          ...
          switch(choice)
          {
			  ...
			  Person e1 = PersonnelFactory.createPersonnel(PersonnelFactory.PersonnelType.EMPLOYEE, lastN, firstN, middleN, empID, salary);
			  ...
			  lastN = scan.nextLine();
				...
				{
				if( per.getPersonList().get(i).getFirstName().equals(firstN) && per.getPersonList().get(i).getLastName().equals(lastN))
				{
				found = true;
				loc = i;
				}
